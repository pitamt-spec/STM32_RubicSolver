...
static void MX_TIM3_Init(void)
{
  ...
  htim3.Init.Period = 66;//FPF, from 79 to 19
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, STPR_D1_Pin|STPR_D5_Pin|STPR_D2_Pin|STPR_D3_Pin
                          |STPR_D4_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : STPR_D1_Pin STPR_D5_Pin STPR_D2_Pin STPR_D3_Pin
                           STPR_D4_Pin */
  GPIO_InitStruct.Pin = STPR_D1_Pin|STPR_D5_Pin|STPR_D2_Pin|STPR_D3_Pin
                          |STPR_D4_Pin;
